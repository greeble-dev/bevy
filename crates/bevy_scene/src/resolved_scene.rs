...
use bevy_asset::{AssetId, AssetRef, AssetServer, Assets, Handle, UntypedAssetId};
use bevy_ecs::{
    ...
    template::{
        FromTemplate, SceneEntityReference, SceneEntityReferences, Template,
        TemplateAssetDependencies, TemplateContext,
    },
