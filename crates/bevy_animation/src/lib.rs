...
/// A component used to identify an animation target entity (e.g. bone in a
/// skinned mesh). The [`AnimationClip`] asset uses this to identify which
/// curves in the clip will drive the target entity.
///
...
/// A component that links an animation target entity to an entity containing an
