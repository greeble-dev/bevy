...
pub(crate) struct AssetInfos {
    path_to_index: HashMap<AssetRef<'static>, TypeIdMap<AssetIndex>>,
    ...
    pub(crate) dependency_failed_event_sender:
        TypeIdMap<fn(&mut World, AssetIndex, AssetRef<'static>, AssetLoadError)>,
...
impl AssetInfos {
    ...
    fn process_handle_drop_internal(
        infos: &mut HashMap<ErasedAssetIndex, AssetInfo>,
        path_to_id: &mut HashMap<AssetRef<'static>, TypeIdMap<AssetIndex>>,
        loader_dependents: &mut HashMap<AssetRef<'static>, HashSet<AssetRef<'static>>>,
        living_labeled_assets: &mut HashMap<AssetRef<'static>, HashSet<Box<str>>>,
